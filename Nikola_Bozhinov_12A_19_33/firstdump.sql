...
CREATE TABLE `c_t` (
  ...
  CONSTRAINT `c_t_ibfk_2` FOREIGN KEY (`t_id`) REFERENCES `tag` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tag` VALUES (1,'sdfsghasdf','ffsdfdsf'),(2,'sdfgsdf','fgdsfgdg');
...
-- Dump completed on 2014-04-26 23:00:39
